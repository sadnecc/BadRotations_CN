...
local locales={
  ...
  ["Trinkets"]="饰品",
  ["Trinket 1"]="饰品1",
  ["Health Percent to Cast At"]="百分之X生命用饰品",
  ["Minimum Trinket 1 Targets(This includes you)"]="包含你在内的饰品1目标",
  ["Minimum Trinket 2 Targets(This includes you)"]="包含你在内的饰品2目标",
  ["Min Trinket 1 Targets"]="饰品1 目标",
  ["Trinket 2"]="饰品2",
  ["Min Trinket 2 Targets"]="饰品2 目标",
  ["Trinket 1 Mode"]="饰品1模式",
  ["Trinket 2 Mode"]="饰品2模式",
  ["BoP Target"]="保护祝福 目标",
  ["Blessing of Sacrifice"]="牺牲祝福",
  ["BoS Target"]="牺牲祝福 目标",
  ["Avenging Wrath"]="复仇之怒",
  ...
  if br and br.ui and br.ui.createText and br.ui.createSection and br.ui.createPagesDropdown then
    ...
    C_Timer.After(2,function()
      BadRotationsButton:SetScript("OnEnter", function(self)
        ...
        GameTooltip:AddLine("汉化by老胡，QQ群855255365")
